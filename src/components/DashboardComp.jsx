...
//       try {
//         const res = await fetch('/api/admin/getusers?limit=5');
...
//       try {
//         const res = await fetch('/api/listing/gets?limit=5');
//         const data = await res.json();
//         if (res.ok) {
...
//   }, [currentUser]);
//   return (
//     <div className='bg-white w-full dark:bg-slate-900'>
...
//               <Table.HeadCell>Lisitng Title</Table.HeadCell>
...
//                       />
//                     </Table.Cell>
//                     <Table.Cell className='w-96'>{listing.name}</Table.Cell>
//                     {/* <Table.Cell className='w-5'>{listing.type}</Table.Cell> */}
//                   </Table.Row>
//                 </Table.Body>
//               ))}
//           </Table>
